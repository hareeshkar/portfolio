      ...
      <div className="mx-auto max-w-7xl px-6 py-8 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 md:order-2">
          <div className="flex space-x-6">
            <a
              ...
              className="text-text-secondary hover:text-accent transition-all duration-300 hover:scale-110 hover:drop-shadow-lg"
            >
          ...
          <div className="text-text-secondary text-xs mt-2 sm:mt-0">
            ...
            <a href="tel:+94771737524" className="block hover:text-accent">
              +94 77 173 7524
            </a>
          </div>
        </div>
        ...
        <div className="mt-4 md:mt-0 md:order-1">
          <p className="text-center text-xs leading-5 text-text-secondary font-sans">
            &copy; {new Date().getFullYear()} RAVI HAREESHKAR — Software
